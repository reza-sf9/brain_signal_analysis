...
load('E:\oneDrive_WPI\OneDrive - Worcester Polytechnic Institute (wpi.edu)\-0\switching_data\ali_11_30_22.mat');
% 
...
config.f_l = 25;                                          % lower bound of desired freq interval
...
while plt_mltp==1
    ...
    cfg_mtp_spect.f_des_l = 5;         % (freq(Hz)) the lower range for plotting spectrogram
