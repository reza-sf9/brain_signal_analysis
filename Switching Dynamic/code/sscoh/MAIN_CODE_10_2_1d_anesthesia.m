...
if plt_ml==1
    ...
    figure,
    plot(ml,'g', 'linewidth', 2)
    xlabel('iteration')
    title('Maximum Likelhood')
...
% load inilial points
[cfg_Init, Y_k]  = gc_load_yk_cfg(ch_num, fr_);
...
%% nested functions 
% load data 
function [cfg_Init, Y_k]= gc_load_yk_cfg(ch_num, fr_)
...
%         str_name_2 = sprintf('Anethesia_cfg_Init_chNum%d_fr13_sr256_winSec8_segNum8_TRIAL', ch_num);
        ...
        str_name_1 = sprintf('switch_data_Yk_chNum%d_fr%d_sr300_winSec5_segNum5_TRIAL', ch_num, fr_);
        str_name_2 = sprintf('switch_data_cfg_Init_chNum%d_fr%d_sr300_winSec5_segNum5_TRIAL', ch_num, fr_);
