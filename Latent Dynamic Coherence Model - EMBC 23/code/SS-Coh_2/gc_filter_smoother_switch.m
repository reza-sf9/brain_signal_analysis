function [Bayes] = gc_filter_smoother_switch(Y_k, Param, mat_switch_ind)
...
[MU_filter, SIGMA_filter, MU_oneStep, SIGMA_oneStep] = gc_bayes_filter_oneStep_switch(Y_k, L, mu, incongruent_vec, W, mu_1_0, sigma_1_0, F, D, Q, dim, mat_switch_ind); % 15.a, 15.b

% figure();
% plot(MU_filter)

% Bayes smoother
[MU_smoother, SIGMA_smoother, G_k]= gc_bayes_smoother_switch(MU_filter, SIGMA_filter, MU_oneStep, SIGMA_oneStep, F, Q, dim, mat_switch_ind);
% figure();
% plot(MU_smoother)
