function [] = vis_GA_x(Bayes_str, xk_sample, dim, iter_plot, strct_min_max, using_sim_data, t_min, q_k)
...
switch using_sim_data
    ...
    case 0
        fun_plt_cnfdnc_intvl_real(MU_smoother, SIGMA_smoother, 'Smoother Estimation', dim, iter_plot, strct_min_max, t_min, q_k)
...
function [] = fun_plt_cnfdnc_intvl_real(mu_estimation, sigma_estimation, tit, dim, iter_plot, strct_min_max, t_min, q_k)
...
% % %         funSub_plt_cnfdnt(x_ind, cnfdnc_intvl_d1, mu_estimation, x_sim, tit, 1, iter_plot, min_1_d1-dev_val, max_1_d1+dev_val)
        funSub_plt_cnfdnt_real(x_ind, cnfdnc_intvl_d1, mu_estimation, tit, 1, iter_plot, min_1_d1-dev_val, max_1_d1+dev_val, t_min, q_k)
    case 2 
        min_1_d1 = strct_min_max.min_1_d1;
        max_1_d1 = strct_min_max.max_1_d1;
        min_1_d2 = strct_min_max.min_1_d2;
...
function [] = funSub_plt_cnfdnt_real(x_ind, cnfdnc_intvl_data, mu_estimation, tit, dim_num, iter_plot, y_min, y_max, t_min, q_k)
fnt_size = 20; 
lgd_size = 12;
num_stp = 3;
