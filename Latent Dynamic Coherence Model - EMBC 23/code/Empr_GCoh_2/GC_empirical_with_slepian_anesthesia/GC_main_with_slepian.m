...
%% this code is used for switch - based on what we want; we need to select different parts of GCoh, 
%% extract data for swithc, and generate inital values for the Switch-SSCoh 
%% also we need to have the time that we select these three parts and use it in the SSCoh to concatenate results together 

%% data
%%% loading data
if exist('data_det') ~=1
    load('E:\oneDrive_WPI\OneDrive - Worcester Polytechnic Institute (wpi.edu)\data\emery_data\eeganes07laplac250_detrend_all.mat');
end
